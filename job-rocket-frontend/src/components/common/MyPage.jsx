...
const MyPage = ({ onClose, onNavigate }) => {
	...
	return (
		<div
			ref={myPageRef}
			className="absolute top-14 right-3 flex items-center justify-center bg-white z-50"
		>
			<div
			...
			>
				...
				<div className="flex items-center justify-center w-full px-6">
					<button
						className="w-[150px] h-[35px] mt-3 text-center text-red-500 text-xl border-2 border-red-500 rounded-lg"
