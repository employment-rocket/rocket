...
const Site = () => {
	return (
		<div className="flex justify-center w-full mt-5 noto-sans-kr-regular">
			{[
				{
					title: "채용 공고",
					links: [
				...
				},
				{
					...
					links: [
						...
						{
							name: "코드트리",
							url: "https://www.codetree.ai/landing",
						},
					],
				},
			].map((section, idx) => (
				<div
					key={idx}
					className={`flex flex-col w-[18%] items-center px-3 ${
						idx !== 4 ? "border-r border-gray-300" : ""
					}`}
				>
					<div
						className="p-4 justify-center rounded-[10px] w-full flex mb-3 noto-sans-kr-bold"
						style={{
