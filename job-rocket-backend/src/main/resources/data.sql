...
-- schedule 테이블 INSERT
INSERT INTO schedule (title, due_date, memo, user_id, type, state) VALUES
                                                                       ...
                                                                       ('서류 전형 결과 발표', '2024-01-18', '서류 탈락.', 2, 'Document', 'Fail'),
                                                                       ('1차 면접 결과 발표', '2024-01-22', '1차 면접 통과.', 2, 'First', 'Passed'),
                                                                       ('2차 면접 준비', '2024-01-28', '2차 면접 예상 질문 준비.', 2, 'Second', 'Ongoing'),
                                                                       ('최종 합격 발표', '2024-02-01', '최종 합격 축하합니다!', 2, 'Final', 'Passed'),
                                                                       ('서류 전형 지원', '2024-01-10', '서류 전형 지원 완료.', 3, 'Document', 'Passed'),
                                                                       ('1차 면접 일정 확인', '2024-01-17', '1차 면접 일정 확인 완료.', 3, 'First', 'Ongoing');
