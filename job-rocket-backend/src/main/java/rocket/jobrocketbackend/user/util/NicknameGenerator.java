...
public class NicknameGenerator {
    ...
    private static final String[] ADJECTIVES = {
            "바위먹은", "빠른", "용감한", "푸른", "행복한", "귀여운", "고요한", "강한", "귀족적인", "산뜻한",
            "차가운", "뜨거운", "미스터리한", "조용한", "황금빛", "빛나는", "당당한", "기쁜", "자유로운", "멋진",
            "어두운", "밝은", "포근한", "상쾌한", "지혜로운", "고결한", "소박한", "화려한", "깔끔한", "정직한",
            "강렬한", "매력적인", "귀족적인", "슬픈", "순수한", "여유로운", "인내심 강한", "정의로운", "은밀한", "대담한",
            "사랑스러운", "넉넉한", "특별한", "자상한", "재치있는", "신비한", "혼자서도 강한", "용의자적인", "전설적인", "신뢰하는",
            "창의적인", "밝은", "재능있는", "차분한", "미친", "긍정적인", "세련된", "실험적인", "편안한", "강직한",
            "정열적인", "섬세한", "호기심이 많은", "섬세한", "도전적인", "위험한", "놀라운", "웅장한", "진지한", "매우 친근한",
            "겁이 없는", "달콤한", "자신감 있는", "강력한", "깨끗한", "침착한", "과감한", "부드러운", "유머러스한", "너그러운",
            "침착한", "타고난", "개성있는", "뛰어난", "감동적인", "파괴적인", "선명한", "성실한", "흔치않은", "놀라운",
            "배려하는", "무뚝뚝한", "열정적인", "도도한", "기쁜", "사려 깊은", "참신한", "모험적인", "미친", "귀족적인"
    };
