...
public interface AnswerJpaRepository extends JpaRepository<AnswerEntity, Long> {
    ...
    AnswerEntity findByMemberAndCategoryAndQid(UserEntity member, String category, Long qid);

    Optional<AnswerEntity> findByMemberIdAndCategoryAndQid(Long memberId, String category, Long qid);
}
